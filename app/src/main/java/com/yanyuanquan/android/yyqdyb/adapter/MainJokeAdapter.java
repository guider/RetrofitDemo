 ...
 * @projectName:YYQDYB
 */
public class MainJokeAdapter extends BaseRecyclerViewAdapter<Joke.ShowapiResBodyEntity.ContentlistEntity> {

    public MainJokeAdapter(List<Joke.ShowapiResBodyEntity.ContentlistEntity> mList, int layoutId) {
